...
export default function SettingsPage() {
	// TODO: update the reminder state
	// TODO: the reminder state is not updating when the user changes the value of the reminder
			...
			<View className='w-full h-full px-4 py-2 md:w-4/5 lg:w-3/5'>
				...
				<View className='p-2'>
					<View className='flex flex-row items-center justify-between'>
						<View className=''>
							<Text className='text-lg font-semibold'>Sedentary Reminder:</Text>
						</View>
						<View>
							<RadioButtonGroup
								containerStyle={{
				...
				{/* result */}
				{/* <Text className='mt-4'>{JSON.stringify(reminder)}</Text> */}
			</View>
		</View>
	);
}
